...
auth_channel = environ.get('AUTH_CHANNEL', '-1001573863139') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002122467397')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002219302448')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002131670256')).split()]
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/93dbd78b52bc9026f31ef.jpg')
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/All_Movie_Star_Link')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'All_Movie_Support') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://main031-a65d00d9e149.herokuapp.com/")
